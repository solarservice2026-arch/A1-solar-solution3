...
export function agreementDocument(row: RecordValue) {
  ...
  const origin = typeof window === "undefined" ? "" : window.location.origin,
    headerImage = `${origin}/document-assets/solar-document-header.png`,
 ...
 @page{size:A4;margin:8mm 12mm}*{box-sizing:border-box}html,body{margin:0;padding:0;color:#161616;font-family:Arial,Helvetica,sans-serif;font-size:9.3px;line-height:1.28}.page{position:relative;break-after:page;page-break-after:always}.page:last-of-type{break-after:auto;page-break-after:auto}.solar-header{display:block;width:100%;height:auto;max-height:46mm;object-fit:cover;border-radius:4px;margin-bottom:4mm}.stamp-wrap{text-align:center;margin-bottom:3mm}.stamp{display:block;width:145mm;height:18mm;object-fit:contain;margin:0 auto}.annexure{text-align:right;font-weight:700}.title{text-align:center;font-size:11.5px;line-height:1.25;margin:2mm 8mm}.center{text-align:center;margin:1.5mm 0}.clause{margin:1.7mm 0}.clause b,.number{font-weight:700}p{margin:1.7mm 0}ol{padding-left:5mm;margin:1.5mm 0}li{margin:1.2mm 0}h3{font-size:10px;margin:2mm 0 1mm}table{width:100%;border-collapse:collapse;margin:2mm 0;break-inside:avoid}th,td{border:1px solid #555;padding:2.5px 4px;text-align:left}th{background:#f0f0f0}.party-grid{display:grid;grid-template-columns:1fr 1fr;gap:14mm;margin-top:9mm;break-inside:avoid}.signature-box{min-height:34mm}.vendor-sign{height:20mm;max-width:58mm;object-fit:contain;display:block;margin:1mm 0}.line{border-top:1px solid #222;padding-top:1.5mm}.disclaimer{font-size:8px;border-top:1px solid #777;padding-top:1.5mm;margin-top:4mm}.actions{position:fixed;right:15px;bottom:15px}@media print{.actions{display:none}.solar-header,.stamp,.vendor-sign{print-color-adjust:exact;-webkit-print-color-adjust:exact}}</style></head><body>
 <section class="page"><img class="solar-header" src="${esc(headerImage)}" alt="A1 Solar Solution Header Banner"><div class="stamp-wrap"><img class="stamp" src="${esc(stamp)}" alt="Agreement stamp paper" onerror="this.onerror=null;this.style.display='none';"><div class="annexure">Annexure 2</div></div><h1 class="title">Agreement between Consumer &amp; Vendor for installation of grid connected rooftop solar (RTS) project<br>under PM – Surya Ghar: Muft Bijali Yojana</h1>
